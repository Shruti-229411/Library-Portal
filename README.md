...
├─ borrow.php
├─ borrowed_book.php
├─ borrowed_book_search.php
├─ borrowed_book_search_print.php
├─ borrow_book.php
├─ composer.json
├─ composer.lock
├─ css
...
├─ penalty.php
├─ phpinfo.php
├─ print_barcode_book.php
├─ print_barcode_individual.php
├─ profile.php
├─ report.php
├─ report_print.php
├─ report_search.php
...
├─ returned_book_search_print.php
├─ screenshots
│  ├─ admin-dashboard.png
│  ├─ Advanced Library Management System Project in PHP with Barcode.png
│  ├─ barcode.png
│  └─ books.png
├─ scripts.php
├─ session.php
...
│           │  ├─ UnknownColorException.php
│           │  └─ UnknownTypeException.php
│           ├─ Helpers
│           │  ├─ BinarySequenceConverter.php
│           │  ├─ ColorHelper.php
│           │  └─ StringHelpers.php
│           ├─ Renderers
│           │  ├─ DynamicHtmlRenderer.php
│           │  ├─ HtmlRenderer.php
│           │  ├─ JpgRenderer.php
│           │  ├─ PngRenderer.php
...
│              ├─ TypeCode32.php
│              ├─ TypeCode39.php
│              ├─ TypeCode39Checksum.php
│              ├─ TypeCode39Extended.php
│              ├─ TypeCode39ExtendedChecksum.php
│              ├─ TypeCode93.php
│              ├─ TypeEan13.php
│              ├─ TypeEan8.php
│              ├─ TypeEanUpcBase.php
│              ├─ TypeIntelligentMailBarcode.php
│              ├─ TypeInterface.php
│              ├─ TypeInterleaved25.php
...
│              ├─ TypePostnet.php
│              ├─ TypeRms4cc.php
│              ├─ TypeStandard2of5.php
│              ├─ TypeStandard2of5Checksum.php
│              ├─ TypeTelepen.php
│              ├─ TypeTelepenNumeric.php
│              ├─ TypeUpcA.php
│              ├─ TypeUpcE.php
│              ├─ TypeUpcExtension2.php
│              └─ TypeUpcExtension5.php
├─ view_admin.php
├─ view_all_barcode.php
├─ view_book.php
├─ view_librarian.php
└─ view_member.php
